      ...
      <div className="relative w-full max-w-sm h-96 bg-[#3e2723] rounded-xl shadow-2xl border-t-4 border-[#5d4037] p-6 flex flex-col items-center">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            exit={{ y: 50, opacity: 0 }}
            className="bg-[#f5f5dc] text-slate-900 p-6 rounded shadow-md w-full h-full flex flex-col relative rotate-1"
          >
            ...
            {stamp && (
              <motion.div
                ...
                className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-4 rounded-lg p-2 font-black text-4xl uppercase tracking-widest opacity-80 mix-blend-multiply ${
